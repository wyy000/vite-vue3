<template lang="pug">
div(class="relative my-6 px-10 space-x-4 flex")
...
import ATablePaging from '../../components/a-table-paging.vue'
import ATableTbodies from '../../components/a-table-tbodies.vue'
  ...
  setup () {
    ...
    state.meta = {
      columns: [
        ...
        {prop: 'updateTime', title: '更新时间', width: 220, fixed: 'right'},
      ],
    }
